describe('Production and Consumption', () => {
  describe('6.1', () => {
    describe(`A representation MUST define deterministic production and consumption rules 
    ...
    describe(`A representation MUST define fragment processing rules for its Media Type that 
      are conformant with the fragment processing rules defined in §Fragment.`, () => {
      test.todo('untestable');
    });
    describe(`A representation SHOULD use the lexical representation of data model data types. 
    ...
    describe(`In order to maximize interoperability, representation specification 
      authors SHOULD register their representation in the 
      DID Specification Registries [DID-SPEC-REGISTRIES].`, () => {
      test.todo('untestable');
    });
    describe(`A conforming producer MUST serialize all entries in the data model 
      that do not have explicit processing rules for the representation being 
      produced using only the representation's data type processing rules.`, () => {
      test.todo('untestable');
    });
    describe(`A conforming producer MUST indicate which representation has 
      been used for a DID document via a Media Type as described in §7.1.2 DID Resolution Metadata.`, () => {
      test.todo('untestable');
    });
    describe(`A conforming consumer MUST add all entries that do not have 
      explicit processing rules for the representation being consumed to 
      the data model using only the representation's data type processing rules.`, () => {
      test.todo('untestable');
    });
    describe(`A conforming consumer MUST determine the representation of 
